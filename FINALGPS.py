...
angle1_2 = 360 - m.atan((x1-x2)/(y2-y1))
angle2_3 = m.atan((y2-y3)/(x3-x2)) + 90
angle3_4 = 360 - m.atan((x3-x4)/(y4-y3))
angle4_5 = m.atan((x5-x4)/(y5-y4))
                ...
                if spliteddata[4] == 'N':
                    ...
                    if x2 - 0.000022541 <= shiplongtitude <= x1 and y1 <= shiplatitude <= y3 + 0.000018195 and (270 <= shipangle <= 360 or 0 <= shipangle <= 90):
                        if shipangle < angle1_2:
                            ...
                            svmot.ChangeDutyCycle(7.5)
                            dcmot.ChangeDutyCycle(8)
                    if ((shiplongtitude <= x2 + 0.000022541 and y2 - 0.000018195 <= shiplatitude <= y2) or (shiplongtitude <= x2 and y2 <= shiplatitude <= y2 + 0.000018195)) and (270 <= shipangle <= 360 or 0 <= shipangle <= 90):
                        print("turn right")
                        svmot.ChangeDutyCycle(9.5)
                        dcmot.ChangeDutyCycle(8)
                    if x2 + 0.000022541 <= shiplongtitude <= x3 - 0.000022541 and y3 - 0.000018195 <= shiplatitude <= y2 + 0.000018195 and 0 <= shipangle <= 180:
                        if shipangle < angle2_3:
                            ...
                            svmot.ChangeDutyCycle(7.5)
                            dcmot.ChangeDutyCycle(8)
                    if x3 -  0.000022541 <= shiplongtitude <= x3 + 0.000022541 and y3 - 0.000018195 <= shiplatitude <= y3 + 0.000018195 and 0 <= shipangle <= 180:
                        print("turn left")
